...
exports.up = async function (db) {
  await db.raw(`CREATE TABLE IF NOT EXISTS seasonal_events (
  ...
  await db.raw('CREATE INDEX IF NOT EXISTS idx_events_active_ends ON seasonal_events (is_active, ends_at)');
};

exports.down = async function (db) {
  await db.raw('DROP INDEX IF EXISTS idx_events_active_ends');
  await db.raw('DROP TABLE IF EXISTS seasonal_events');
};
