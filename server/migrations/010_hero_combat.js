exports.up = async function (db) {
  ...
  await db.raw('ALTER TABLE "players" ADD COLUMN "deployed_hero_id" INTEGER DEFAULT NULL');
  // Per-hero recovery window after a lost battle
  await db.raw('ALTER TABLE "player_heroes" ADD COLUMN "recovery_until" TEXT DEFAULT NULL');
};
