...
// (0..2)×(0..2) keep their exact coords + names so any existing territory_id
...
const SEED_TERRITORIES = [
  // ─── Original 3×3 inner core (unchanged from previous seed) ───
  ...
  // Eastern column (x=3)
  { name: 'Bosque Salvaje',   grid_x: 3, grid_y: 0, type: 'forest',   defense_strength: 90,  resources_bonus: { wood: 6 } },
  { name: 'Mercado Real',     grid_x: 3, grid_y: 1, type: 'plains',   defense_strength: 100, resources_bonus: { gold: 7 } },
  { name: 'Bahía Pirata',     grid_x: 3, grid_y: 2, type: 'coast',    defense_strength: 95,  resources_bonus: { gold: 6 } },
  { name: 'Dunas del Sur',    grid_x: 3, grid_y: 3, type: 'sand',     defense_strength: 65,  resources_bonus: { iron: 3 } },
  { name: 'Mercado Lejano',   grid_x: 3, grid_y: 4, type: 'sand',     defense_strength: 85,  resources_bonus: { gold: 6 } },

  // Far east column (x=4)
  { name: 'Acantilados',      grid_x: 4, grid_y: 0, type: 'mountain', defense_strength: 95,  resources_bonus: { iron: 5 } },
  { name: 'Cordillera Negra', grid_x: 4, grid_y: 1, type: 'mountain', defense_strength: 115, resources_bonus: { stone: 6 } },
  { name: 'Llanura del Vino', grid_x: 4, grid_y: 2, type: 'plains',   defense_strength: 80,  resources_bonus: { wheat: 7 } },
  ...
  { name: 'Capital Imperial', grid_x: 2, grid_y: 4, type: 'plains',   defense_strength: 150, resources_bonus: { gold: 12, wheat: 4 } },
];
